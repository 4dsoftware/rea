function [alpha,beta,gamma] = RSA_package(data,ca,cb)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Notes
%
%Response Surface Analysis (REA) is a set of emthods to quantitatively 
...
%Cokol, M., et al, MSB, 2011. One can also use the s0 value from SAP_package.
%
%References:
%
