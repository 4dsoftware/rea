...
c1 = package_envelope_hill([median(dose1) 2],[1;effu1],[base1;dose1],bot); %regression for drug 1
lam1 = c1(1); h1 = c1(2); %EC50 and Hill slope for drug 1
c2 = package_envelope_hill([median(dose2) 2],[1;effu2],[base2;dose2],bot); %regression for drug 2
...
if custom_label == 1
    set('xtick',(log10(xlb)),'xticklabel',num2cell((xlb)),'ytick',(log10(ylb)),'yticklabel',num2cell((ylb)));
else
